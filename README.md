...
> Άνοιγμα αυτής της σελίδας στο [https://theofilosgeo.github.io/light-sensor/](https://theofilosgeo.github.io/light-sensor/)
...
* αναζήτηση για **https://github.com/theofilosgeo/light-sensor** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/theofilosgeo/light-sensor/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/theofilosgeo/light-sensor** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/theofilosgeo/light-sensor/raw/master/.github/makecode/blocks.png)
